...
class RegionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'name' => 'required|string|unique:regions,name,NULL,id,parent_id,' . ($request['parent'] ?: 'NULL'),
            'slug' => 'required|string|unique:regions,slug,NULL,id,parent_id,' . ($request['parent'] ?: 'NULL'),
    ...
    {
        $this->validate($request, [
            'name' => 'required|string|unique:regions,name,' . $region->id . ',id,parent_id,' . $region->parent_id,
            'slug' => 'required|string|unique:regions,slug,' . $region->id . ',id,parent_id,' . $region->parent_id,
        ]);
